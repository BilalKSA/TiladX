...
const contentItems = [
  ...
  { icon: '📝', title: 'الاختبارات الإلكترونية المطورة', description: 'اختبارات محاكية لقياس استعدادك وتتبع تقدّمك.' },
  { icon: '🗂️', title: 'خطط المذاكرة', description: 'خطة أسبوعية منظمة لتغطية محتوى الدورة بثبات.' },
  { icon: '✨', title: 'المزايا الإضافية', description: 'مواد وأدوات إضافية داعمة لمسارك في الدورة.' },
]
