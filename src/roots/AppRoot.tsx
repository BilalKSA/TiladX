...
function AppRoot() {
  return (
    <>
      <Routes>
        {/* The marketing site owns "/" and lives on another origin. Firebase
            redirects it there on a real request; this covers client-side
            navigation, which never reaches the server. */}
